...
const styles = StyleSheet.create({
  ...
  claimsTitle: { fontSize: Type.bodyLg, fontWeight: '800' },
  claimRow: { flexDirection: 'row', alignItems: 'center', gap: 10 },
  claimName: { fontSize: Type.bodyLg, fontWeight: '700' },
  claimMeta: { fontSize: Type.caption, marginTop: 1 },
  claimStatus: { fontSize: Type.footnote, fontWeight: '800' },
  safe: { flex: 1 },
  ...
  headerText: { gap: 2 },
  eyebrow: { fontSize: Type.footnote, fontWeight: '800', letterSpacing: 1, textTransform: 'uppercase' },
  ...
  switchText: { fontSize: Type.footnote, fontWeight: '800' },
  ...
  storeName: { fontSize: Type.sheetTitle, fontWeight: '800', letterSpacing: -0.4, flexShrink: 1 },
  storeMeta: { fontSize: Type.caption, marginTop: 2 },
  confirmBadge: { flexDirection: 'row', alignItems: 'center', gap: 3, borderRadius: Radius.full, paddingHorizontal: 8, paddingVertical: 4 },
  confirmText: { fontSize: Type.micro, fontWeight: '800' },
  metrics: { flexDirection: 'row', alignItems: 'center' },
  metric: { flex: 1, alignItems: 'center', gap: 5 },
  metricLabel: { fontSize: Type.caption, fontWeight: '700' },
  metricValue: { fontSize: Type.callout, fontWeight: '800' },
  metricDivider: { width: 1, alignSelf: 'stretch', marginVertical: 4 },
  condition: { fontSize: Type.footnote, lineHeight: 18 },
  ...
  alertTitle: { fontSize: Type.body, fontWeight: '800' },
  alertBody: { fontSize: Type.footnote, lineHeight: 17 },
  menuGroup: { gap: Spacing.sm },
  menuHead: { fontSize: Type.footnote, fontWeight: '800', letterSpacing: 0.3, paddingLeft: 4 },
  ...
  emptyText: { fontSize: Type.body, textAlign: 'center', lineHeight: 20 },
  emptyBtn: { borderRadius: Radius.md, paddingHorizontal: 20, paddingVertical: 12 },
  emptyBtnText: { fontSize: Type.bodyLg, fontWeight: '800' },
