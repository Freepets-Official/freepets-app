...
const styles = StyleSheet.create({
  ...
  segLabel: { fontSize: Type.body, fontWeight: '800', letterSpacing: -0.2 },
  pickHint: { fontSize: Type.footnote, fontWeight: '700', marginTop: 2 },
  ...
  specialTitle: { fontSize: Type.bodyLg, fontWeight: '800' },
  specialBody: { fontSize: Type.body, lineHeight: 20 },
  specialTips: { gap: 4 },
  specialTipsLabel: { fontSize: Type.footnote, fontWeight: '800' },
  specialTipRow: { flexDirection: 'row', alignItems: 'center', gap: 5 },
  specialTipText: { fontSize: Type.footnote },
  ownerNote: { borderWidth: 1, borderRadius: Radius.md, padding: Spacing.md, gap: 3 },
  ownerNoteLabel: { fontSize: Type.caption, fontWeight: '800' },
  ownerNoteText: { fontSize: Type.body, lineHeight: 19 },
  callBtn: {
    flexDirection: 'row',
    alignItems: 'center',
    justifyContent: 'center',
  ...
  callBtnText: { fontSize: Type.bodyLg, fontWeight: '800' },
  ...
  name: { fontSize: Type.screenTitle, lineHeight: 34, fontWeight: '900', letterSpacing: -1, marginBottom: 4 },
  ...
  passTitle: { fontSize: Type.callout, fontWeight: '800', letterSpacing: -0.3 },
  passBody: { fontSize: Type.footnote, lineHeight: 17 },
  reportLink: {
    flexDirection: 'row',
    alignItems: 'center',
    justifyContent: 'center',
  ...
  reportText: { fontSize: Type.body, fontWeight: '700' },
  metaRow: { flexDirection: 'row', alignItems: 'center', gap: 5 },
  meta: { fontSize: Type.body, flexShrink: 1 },
  ...
  rawLabel: { fontSize: Type.caption, fontWeight: '800', letterSpacing: 0.8, textTransform: 'uppercase' },
  confLine: { flexDirection: 'row', alignItems: 'center', gap: 7, flexWrap: 'wrap' },
  confLineText: { fontSize: Type.footnote, fontWeight: '600', flexShrink: 1 },
  rawText: { fontSize: Type.bodyLg, lineHeight: 22 },
  rawSource: { fontSize: Type.caption },
  mapCard: { borderRadius: Radius.lg, borderWidth: 1, padding: Spacing.lg, gap: 8 },
  mapHead: { flexDirection: 'row', alignItems: 'center', gap: 6 },
  mapLabel: { fontSize: Type.body, fontWeight: '800' },
  mapAddr: { fontSize: Type.body, lineHeight: 19 },
  mapBtn: {
    flexDirection: 'row',
    alignItems: 'center',
    justifyContent: 'center',
  ...
  mapBtnText: { fontSize: Type.body, fontWeight: '800' },
  ...
  checkError: { fontSize: Type.footnote, textAlign: 'center', marginTop: 8 },
  ...
  resultTitle: { fontSize: Type.sectionTitle, fontWeight: '900', letterSpacing: -0.5, flexShrink: 1 },
  ...
  verdictPet: { fontSize: Type.callout, fontWeight: '800' },
  verdictReason: { fontSize: Type.body, lineHeight: 19 },
  conditionRow: { flexDirection: 'row', alignItems: 'center', gap: 7 },
  conditionItem: { fontSize: Type.body, fontWeight: '600', flexShrink: 1 },
  card: { borderRadius: Radius.lg, borderWidth: 1, padding: Spacing.xl, gap: Spacing.md },
  cardTitle: { fontSize: Type.cardTitle, fontWeight: '800', letterSpacing: -0.4 },
  checkItem: { flexDirection: 'row', alignItems: 'center', gap: Spacing.md },
  checkItemLabel: { fontSize: Type.bodyLg, flexShrink: 1 },
  ...
  tipText: { fontSize: Type.body, flexShrink: 1, lineHeight: 20 },
