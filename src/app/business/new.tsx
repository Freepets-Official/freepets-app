...
const styles = StyleSheet.create({
  ...
  stepText: { fontSize: 14.5, fontWeight: '800' },
  ...
  input: { borderWidth: 1, borderRadius: Radius.md, paddingHorizontal: Spacing.md, paddingVertical: 11, fontSize: 14.5 },
  ...
  dupTitle: { fontSize: 14.5, fontWeight: '800' },
  dupBody: { fontSize: 12.5, lineHeight: 18 },
  ...
  dupName: { fontSize: 13.5, fontWeight: '800' },
  dupAddr: { fontSize: 11.5, marginTop: 2 },
  ackRow: { flexDirection: 'row', alignItems: 'center', gap: 7, paddingVertical: 4 },
  ackText: { fontSize: 13, fontWeight: '700' },
  error: { fontSize: 12.5, lineHeight: 18, fontWeight: '600' },
  ...
  doneRowText: { fontSize: 13.5, fontWeight: '800' },
  ...
  doneTitle: { fontSize: 22, fontWeight: '900', letterSpacing: -0.5 },
  doneBody: { fontSize: 13.5, lineHeight: 21, textAlign: 'center' },
});
